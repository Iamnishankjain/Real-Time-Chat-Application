...
import { getFriendRequest,acceptFriendRequest } from '../library/api.js';
          ...
          {incomingRequests.length>0 && (
            <section className='space-y-4'>
              <h2 className='text-xl font-semibold flex items-center gap-2'>
                ...
                FriendRequests
                <span className='badge badge-primary mt-2'>{incomingRequests.length}</span>
              </h2>
                  ...
                  <div key={request._id} className='card bg-base-200 shadow-sm hover:shadow-md transition-shadow'>
                    <div className='card-body p-4'>
                      <div className='flex items-center justify-between'>
                        ...
                        <button onClick={()=> acceptFriendRequestMutation(request._id)} className='btn btn-primary btn-sm'>Accept</button>
                      </div>
                    </div>
                  </div>
                ))}
                    ...
                    <div className='card-body p-4'>
                      <div className='flex items-start gap-3'>
                        <div className='avatar mt-1 size-10 rounded-full'>
                          <img src={notification.receiver.profilePicture} alt={notification.receiver.fullName} />
                        </div>
